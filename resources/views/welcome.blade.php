...
<html lang="en">
    <head>
        ...
        <title>DryFood | Find Healthy DryFood</title>
    </head>
    <body class="mb-48">
        ...
        >
            <div
                class="absolute top-0 left-0 w-full h-full bg-no-repeat bg-cover"
                style="background-image: url('images/dried-organic-fruits-assortment_114579-49248.jpg')"
            ></div>
            ...
            <div class="z-10">
                ...
                <p class="text-2xl text-gray-200 font-bold my-4">
                    Find Healthy DryFood
                </p>
                <div>
                    <a
                        href="register.html"
                        class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:bg-sky-700"
                        >Sign Up to Buy </a
                    >
                </div>
            </div>
